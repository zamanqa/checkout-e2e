// shopware6-braintree-invoice.cy.js - Shopware6 + Braintree + Invoice Checkout Test
...
describe('Shopware6 + Braintree + Invoice Checkout', () => {
  ...
  it('Complete an Order for Shopware6 Braintree Invoice and Validate in CMS Database', function () {
    cy.log('========== Shopware6 Braintree Invoice Checkout Test ==========');
    ...
    // Step 9: Select Pay with invoice
    cy.log('--- Step 9: Select Pay with invoice ---');
    cy.get("button[data-test-id='select-invoice']").click();
