// shopify-stripe-sepa.cy.js - Shopify + Stripe + SEPA Debit Checkout Test
...
describe('Shopify + Stripe + SEPA Debit Checkout', () => {
  ...
  it('Complete an Order for Shopify Stripe SEPA and Validate in CMS Database', function () {
    cy.log('========== Shopify Stripe SEPA Checkout Test ==========');
    ...
    // Step 9: Fill Stripe SEPA Debit details
    cy.log('--- Step 9: Fill Stripe SEPA Debit details ---');
    StripeComponent.fillSepaDebit(paymentData.iban);
