// saleor-mollie-invoice.cy.js - Saleor + Mollie + Invoice Checkout Test
...
describe('Saleor + Mollie + Invoice Checkout', () => {
  ...
  it('Complete an Order for Saleor Mollie Invoice and Validate in CMS Database', function () {
    cy.log('========== Saleor Mollie Invoice Checkout Test ==========');
    ...
    // Step 8: Select Pay with invoice
    cy.log('--- Step 8: Select Pay with invoice ---');
    MollieComponent.selectInvoice();
    cy.wait(2000);
