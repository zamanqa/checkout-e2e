// shopify-adyen-invoice.cy.js - Shopify + Adyen + Invoice Checkout Test
...
describe('Shopify + Adyen + Invoice Checkout', () => {
  ...
  it('Complete an Order for Shopify Adyen Invoice and Validate in CMS Database', function () {
    cy.log('========== Shopify Adyen Invoice Checkout Test ==========');
