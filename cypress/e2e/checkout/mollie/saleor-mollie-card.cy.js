// saleor-mollie-card.cy.js - Saleor + Mollie + Card Checkout Test
...
describe('Saleor + Mollie + Card Checkout', () => {
  ...
  it('Complete an Order for Saleor Mollie Card and Validate in CMS Database', function () {
    cy.log('========== Saleor Mollie Card Checkout Test ==========');
...
/*
    // Step 8: Click on Payment Method section to expand it
    cy.log('--- Step 9: Click on Payment Method section ---');
    cy.contains('PAYMENT METHOD').click();
    cy.wait(3000);
*/

    // Step 9: Select Mollie Credit Card payment method
    cy.log('--- Step 10: Select Mollie Credit Card ---');
    MollieComponent.selectCreditCard();
    cy.wait(3000);

    // Step 10: Click Continue to proceed to payment
    ...
    // Step 12: Click Pay button to redirect to Mollie payment page
    cy.log('--- Step 12: Click Pay button ---');
    CheckoutPage.clickPay();

    // Step 13: Handle Mollie payment page (cross-origin)
    cy.log('--- Step 13: Fill Mollie card details ---');
